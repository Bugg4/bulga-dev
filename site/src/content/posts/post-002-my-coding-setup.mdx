...
I _will_ say that Linus Torvalds' recent take gave me a chuckle: [when asked about AI-generated kernel patches](https://lore.kernel.org/linux-media/CAHk-=wi4zC+Ze8e+p3tMv8TtG_80KzsZ1syL9anBtmEh5Z40vg@mail.gmail.com/), his response was essentially "if you're anti-AI, just fork the kernel."
...
[Opencode](https://github.com/anomalyco/opencode) is an open-source CLI coding agent.
...
1. I have VSCode open for browsing, editing, and understanding the codebase.
1. I have opencode running in the integrated terminal, waiting for instructions.
1. I describe what I want, opencode goes off and does it, I review the diff, I tweak what I don't like, I commit.
...
[DCP](https://github.com/Opencode-DCP/opencode-dynamic-context-pruning) is a context management plugin that automatically compresses older parts of the conversation to keep the context window lean.
...
[ADtention](https://adtention.ai/) is delightfully simple: it adds a single sponsor line to the bottom of your opencode terminal, and you earn a small amount every time it refreshes.
...
Now, I know what you're thinking. _"An ad plugin reading my code? Hard pass."_<br />
...
No code, no file contents, no prompts, no replies, no file names or repo names — nothing identifying leaves your box.<br />
